...
function ArticleForm() {const { id } = useParams();
...
const onSubmitCreate = (data) => {
  ...
  axiosClient
    ...
    .then(() => {
      setNotification("article Successfully Created");
      navigate("/administrator/article-management");
    })
    .catch((error) => {
      setIsLoading(false);
...
const onSubmitUpdate = (data) => {
  ...
  setFormErrors(null);
  axiosClient
    .post(`/article/update/${id}`, formData, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    })
